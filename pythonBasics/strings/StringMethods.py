...
print(len(parrot))#size of the string variable
print(parrot.lower())#convers in lower case all the letters in the string
print(parrot.upper())#convers in upper case all the letters in the string
print(str(pi))#convert a numerical variable into a string  
