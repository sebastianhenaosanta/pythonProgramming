...
1*You are going shopping. Let’s make a grocery list so that you can plan your budget.
...
2*Each cucumber costs 3.25 doubloons. Store the price per cucumber in a variable called
